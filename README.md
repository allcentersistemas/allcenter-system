...
3. En **Environment Variables**, rellena las keys de `.env.example` (URLs JDBC completas, `JWT_SECRET`, `APP_BIESSE_INTERNAL_TOKEN`). Sin `${...}` dentro de ningún valor. Si el Postgres es de Coolify, activa **Connect To Predefined Network**.
